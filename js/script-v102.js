...
function ishaIqamahTime(currentPrayerTime, currentIqamahTime) {
    ...
    if (prayerTimeMinutes < 1170 && iqamahTimeMinutes <= 1170) return '19:30';
    if (prayerTimeMinutes < 1290 && iqamahTimeMinutes > 1290) return '21:30';
    return (prayerTimeMinutes >= 1290) ? currentPrayerTime : currentIqamahTime;
}
